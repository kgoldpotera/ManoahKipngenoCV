		...
		<section class="reveal-section mb-16">
			...
			<div class="glass-card p-8">
				<p class="leading-relaxed text-slate-300">
					...
					Traditional server-side search introduces latency, loading spinners, and failed requests on
					poor connections. The challenge was to build a search experience that feels instantaneous —
					querying thousands of drug entries across multiple collections without a single network request.
				</p>
			</div>
		</section>
			...
			<div class="space-y-4">
				<div class="glass-card p-6">
					...
					<p class="text-sm leading-relaxed text-slate-400">
						Designed a search architecture that simultaneously queries drugs, active ingredients,
						diseases, and manufacturer collections in IndexedDB. Results are merged and deduplicated
						before presentation.
					</p>
				</div>
				<div class="glass-card p-6">
					...
					<p class="text-sm leading-relaxed text-slate-400">
						Engineered a multi-tiered sorting algorithm on top of Fuse.js to override default fuzzy
						scoring. Prioritizes exact matches, then prefix matches, then token matches — ensuring
						the most relevant drug surfaces first, every time.
					</p>
				</div>
				<div class="glass-card p-6">
					<h3 class="mb-2 font-bold text-cyan-400">3. Debounced Input with Instant Feedback</h3>
					<p class="text-sm leading-relaxed text-slate-400">
						Implemented smart debouncing that balances responsiveness with performance. The UI
						provides instant visual feedback while the search engine processes in the background,
						creating the perception of zero latency.
					</p>
				</div>
			</div>
		</section>
