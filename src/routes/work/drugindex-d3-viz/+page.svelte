	...
	<div class="mx-auto max-w-4xl">
		...
		<div class="case-hero mb-16">
			...
			<p class="mt-6 text-lg leading-relaxed text-slate-400">
				Designed and built a dynamic, multi-series SVG line chart that lets clinicians and
				pharmacists visualize complex drug price variations across 20 historical publication
				editions — all rendered client-side with zero network latency.
			</p>
		</div>
		...
		<section class="reveal-section mb-16">
			...
			<div class="glass-card p-8">
				<p class="leading-relaxed text-slate-300">
					DrugIndex.it maintains a massive dataset of drug pricing across multiple editions of
					Kenya's pharmaceutical directory. Clinicians needed a way to <strong class="text-cyan-400"
						>visually track price changes</strong
					> over time for individual drugs — but the data was trapped in static tables. The challenge
					was to build an interactive, performant visualization that could render thousands of data points
					instantly, entirely client-side.
				</p>
			</div>
		</section>
			...
			<div class="space-y-4">
				<div class="glass-card p-6">
					...
					<p class="text-sm leading-relaxed text-slate-400">
						Integrated D3.js directly into Svelte components, using Svelte's reactivity to drive D3
						transitions. Instead of letting D3 own the DOM, I used it purely for scales, axes, and
						path generation — keeping Svelte in control of rendering for optimal performance.
					</p>
				</div>
				<div class="glass-card p-6">
					<h3 class="mb-2 font-bold text-cyan-400">2. Dexie.js LiveQuery Binding</h3>
					<p class="text-sm leading-relaxed text-slate-400">
						Engineered real-time UI data binding by integrating Dexie.js (liveQuery) with Svelte's
						reactivity model. Charts and tables automatically re-render when IndexedDB data changes
				...
				<div class="glass-card p-6">
					...
					<p class="text-sm leading-relaxed text-slate-400">
						Built support for overlaying multiple drug price series on a single chart with distinct
						color coding, interactive tooltips, and smooth animated transitions between data states.
					</p>
				</div>
			</div>
		</section>
