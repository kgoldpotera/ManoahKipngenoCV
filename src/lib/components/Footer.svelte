...
<footer class="relative mt-auto border-t border-white/5">
	<div class="mx-auto max-w-7xl px-6 py-12">
		<div class="flex flex-col items-center gap-8 md:flex-row md:justify-between">
			...
			<div class="flex items-center gap-4">
				<a
					...
					class="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 text-slate-400 transition-all duration-300 hover:border-cyan-500/30 hover:text-cyan-400"
					aria-label="GitHub"
				>
		...
		<p class="mt-6 text-center text-xs text-slate-600">
			&copy; {currentYear} Manoah Kipngeno. Crafted with precision for actualfood.
		</p>
	</div>
</footer>
